...
//	    System.out.println(eval);
	...
	@Test
	public void testNegative_EndCases() throws Exception {
		Memory memory = new HashMapMemory();
		Calculator calc = new Calculator(memory);
	...
	@Test
	public void testNegative_EmptyInput() throws Exception {
		Memory memory = new HashMapMemory();
		Calculator calc = new Calculator(memory);
	    ...
	    thrown.expect( StatementException.class );
	    thrown.expectMessage(StatementException.makeErrCode(8));
		Stream.of("").forEach(strStmt -> calc.evaluate(strStmt));
	}

	@Test
	public void testNegative_NullInput() throws Exception {
		Memory memory = new HashMapMemory();
		Calculator calc = new Calculator(memory);
